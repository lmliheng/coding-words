...
import wordRank from '@/components/wordRank.vue'
...
<template>
  <div id="home" class="w-full h-screen">
    ...
    <div class="w-3/5 m-auto h-96 mt-32 flex items-center justify-center ">
        <wordRank class="w-2/5 h-96 m-auto   flex items-center justify-center" ></wordRank>
        <userRank class="w-2/5 h-96 m-auto   flex items-center justify-center"></userRank>
    </div>
  </div>
</template>
